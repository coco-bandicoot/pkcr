...
EvosAttacksPointers::
	indirect_table 2, 1
	indirect_entries JOHTO_POKEMON - 1, EvosAttacksPointers1, BANK("Evolutions and Attacks 1")
	indirect_entries NUM_POKEMON, EvosAttacksPointers2, BANK("Evolutions and Attacks 2")
	indirect_table_end
